from v1.strategies.strategy import RandomStrategy, ManualStrategy, RLStrategy, AlphaBetaPruningStrategy, ClassificationStrategy, MCTSStrategy
...
class Player:
    def __init__(self, id: int, strategy: str = "random"):
        ...
        if strategy == "random":
            ...
            self.strategy = MCTSStrategy(player_id=id)
